...
class _ChooseLocationState extends State<ChooseLocation> {
  ...
  List<WorldTime> locations = [
    ...
    WorldTime(url: 'Europe/Berlin', location: 'Athena', flag: 'greece.jpg'),
    WorldTime(url: 'Africa/Cairo', location: 'Cairo', flag: 'egypt.png'),
    WorldTime(url: 'Africa/Nairobi', location: 'Nariobi', flag: 'kenya.png'),
    WorldTime(url: 'America/Chicago', location: 'Chicago', flag: 'usa.png'),
    WorldTime(url: 'Asia/Seoul', location: 'South Korea', flag: 'south_korea.png'),
    WorldTime(url: 'America/New_York', location: 'New York', flag: 'usa.png'),
    WorldTime(url: 'Asia/Ho_Chi_Minh', location: 'HoChiMinh', flag: 'china.png'),
